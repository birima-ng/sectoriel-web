...
import { AddEntrepriseComponent } from './add/add-entreprise.component';
...
this.cdr.detectChanges(); // Forcer la détection des changements
 ...
 console.log("################2");
    ...
    openContent() {
        const modalRef = this.modalService.open(AddEntrepriseComponent , { windowClass: 'custom-modal' });
 ...
 modalRef.result.then((result) => {
      ...
      // Handle dismiss reason if needed
        ...
        modalRef.componentInstance.entity = entreprise;
    }
