...
import { AddEtatCourrierComponent } from './add/add-etat-courrier.component';
...
import {EtatCourrierService} from "../../services/etat-courrier.service";
import { ToastrService } from 'ngx-toastr';
declare var window: any;

@Component({
    selector: 'app-etat-courrier',
    templateUrl: './etat-courrier.component.html',
    styleUrls: ['./etat-courrier.component.scss'],
})

export class EtatCourrierComponent implements OnInit {
...
getAllEtatCourrier() {
 ...
 console.log("################1");
 this.etatCourrierService.geEtatCourriers().subscribe( data => {
 this.spinner.hide();
...
this.cdr.detectChanges(); // Forcer la détection des changements
 ...
 console.log("################2");
    ...
    openContent() {
        const modalRef = this.modalService.open(AddEtatCourrierComponent);
 modalRef.result.then((result) => {
    ...
    formEdit(etatCourrier: EtatCourrier) {
        const modalRef = this.modalService.open(AddEtatCourrierComponent);
 modalRef.result.then((result) => {
      if (result === 'Data updated') {
        this.getAllEtatCourrier();
      ...
      // Handle dismiss reason if needed
        ...
        modalRef.componentInstance.entity = etatCourrier;
    }
