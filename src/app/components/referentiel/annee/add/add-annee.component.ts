...
@Component({
  ...
  styleUrls: ['./add-annee.component.scss']
})
...
public activeModal: NgbActiveModal,
 ...
 private typeuniteService: AnneeService,
...
add(){
    ...
    this.typeuniteService.createAnnee(this.addForm.value).subscribe(
      data => {
 if(data){
 this.spinner.hide();
...
edit(){
    ...
    this.typeuniteService.updateAnnee(this.addForm.value).subscribe(
      data => {
if(data){
 this.spinner.hide();
