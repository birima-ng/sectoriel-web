...
@Component({
  selector: 'app-add-frequence-collecte',
  templateUrl: './add-frequence-collecte.component.html',
  styleUrls: ['./add-frequence-collecte.component.scss']
})

export class AddFrequenceCollecteComponent {
invalidLogin = false;
submitted=false;
lng="en";
typeunite: FrequenceCollecte;
...
public activeModal: NgbActiveModal,
 ...
 private typeuniteService: FrequenceCollecteService,
...
add(){
    ...
    this.typeuniteService.createFrequenceCollecte(this.addForm.value).subscribe(
      data => {
 if(data){
 this.spinner.hide();
...
edit(){
    ...
    this.typeuniteService.updateFrequenceCollecte(this.addForm.value).subscribe(
      data => {
if(data){
 this.spinner.hide();
