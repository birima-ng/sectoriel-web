...
@Component({
  selector: 'app-add-type-chargement',
  templateUrl: './add-type-chargement.component.html',
  styleUrls: ['./add-type-chargement.component.scss']
})

export class AddTypeChargementComponent {
invalidLogin = false;
submitted=false;
lng="en";
...
add(){
    ...
    this.typechargementService.createTypeChargement(this.addForm.value).subscribe(
      data => {
if(data){
...
edit(){
    ...
    this.typechargementService.updateTypeChargement(this.addForm.value).subscribe(
      data => {
if(data){
console.log("################################ Data ", data);
 this.spinner.hide();
