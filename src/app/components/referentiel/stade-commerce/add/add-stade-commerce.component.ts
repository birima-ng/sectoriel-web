...
@Component({
  selector: 'app-add-stade-commerce',
  templateUrl: './add-stade-commerce.component.html',
  styleUrls: ['./add-stade-commerce.component.scss']
})

export class AddStadeCommerceComponent {
invalidLogin = false;
submitted=false;
lng="en";
