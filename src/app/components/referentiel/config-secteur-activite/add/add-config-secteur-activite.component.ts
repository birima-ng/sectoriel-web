...
@Component({
  selector: 'app-add-config-secteur-activite',
  templateUrl: './add-config-secteur-activite.component.html',
  styleUrls: ['./add-config-secteur-activite.component.scss']
})

export class AddConfigSecteurActiviteComponent {
invalidLogin = false;
submitted=false;
lng="en";
