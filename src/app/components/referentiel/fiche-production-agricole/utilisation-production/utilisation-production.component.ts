...
@Component({
    selector: 'app-utilisation-production',
    templateUrl: './utilisation-production.component.html',
styleUrls: [
"./utilisation-production.component.scss",
"../../../../../assets/sass/libs/datatables.scss",
],
encapsulation: ViewEncapsulation.None,
})

export class UtilisationProductionComponent implements OnInit {
