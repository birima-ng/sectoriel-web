...
if(this.action == 'edit'){
      ...
      nom: this.entity.nom,
      departement: this.entity.commune.departement,
      commune: this.entity.commune,
    });
this.departement = this.entity.commune.departement;
this.region = this.entity.commune.departement.region;
...
add(){
    ...
    this.villageService.createVillage(this.addForm.value).subscribe(
      data => {
...
edit(){
    ...
    this.villageService.updateVillage(this.addForm.value).subscribe(
      data => {
console.log("################################ Data ", data);
 this.spinner.hide();
