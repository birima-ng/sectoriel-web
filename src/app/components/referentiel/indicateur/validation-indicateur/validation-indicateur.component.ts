...
@Component({
    selector: 'app-validation-indicateur',
    templateUrl: './validation-indicateur.component.html',
styleUrls: [
"./validation-indicateur.component.scss",
"../../../../../assets/sass/libs/datatables.scss",
],
encapsulation: ViewEncapsulation.None,
})

export class ValidationIndicateurComponent implements OnInit {
