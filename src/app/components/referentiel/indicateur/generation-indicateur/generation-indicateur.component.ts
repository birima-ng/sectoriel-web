...
@Component({
    selector: 'app-generation-indicateur',
    templateUrl: './generation-indicateur.component.html',
styleUrls: [
"./generation-indicateur.component.scss",
"../../../../../assets/sass/libs/datatables.scss",
],
encapsulation: ViewEncapsulation.None,
})

export class GenerationIndicateurComponent implements OnInit {
