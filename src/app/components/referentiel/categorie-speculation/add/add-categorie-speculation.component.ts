...
@Component({
  selector: 'app-add-categorie-speculation',
  templateUrl: './add-categorie-speculation.component.html',
  styleUrls: ['./add-categorie-speculation.component.scss']
})

export class AddCategorieSpeculationComponent {
invalidLogin = false;
submitted=false;
lng="en";
categoriespeculation: CategorieSpeculation;
...
add(){
    ...
    this.categoriespeculationService.createCategorieSpeculation(this.addForm.value).subscribe(
      data => {
 if(data){
 this.spinner.hide();
...
edit(){
    ...
    this.categoriespeculationService.updateCategorieSpeculation(this.addForm.value).subscribe(
      data => {
if(data){
 this.spinner.hide();
