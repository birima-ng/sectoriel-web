...
@Component({
selector: 'app-add-appartenance-vehicule',
templateUrl: './add-appartenance-vehicule.component.html',
styleUrls: ['./add-appartenance-vehicule.component.scss']
})

export class AddAppartenanceVehiculeComponent {
invalidLogin = false;
submitted=false;
lng="en";
...
add(){
    ...
    this.appartenancevehiculeService.createAppartenanceVehicule(this.addForm.value).subscribe(
      data => {
...
edit(){
    ...
    this.appartenancevehiculeService.updateAppartenanceVehicule(this.addForm.value).subscribe(
      data => {
if(data){
 this.spinner.hide();
//fermer le popup
