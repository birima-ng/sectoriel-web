...
@Component({
    selector: 'app-baac-avalider',
    templateUrl: './baac-avalider.component.html',
    styleUrls: ['./baac-avalider.component.scss'],
})

export class BaacAValiderComponent implements OnInit {
